        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="p-6">
            <div className="flex justify-end mb-4">
              <button
                onClick={toggleEdit}
                className="flex items-center px-4 py-2 bg-amber-500 text-white rounded-full hover:bg-amber-600 transition-colors"
              >
                {isEditing ? (
                  <>
                          ...
                          <div className="flex items-center">
                            {[1, 2, 3, 4, 5].map((star) => (
                              <button
                                ...
                                className={`w-6 h-6 ${star <= book.rating ? 'text-yellow-400' : 'text-gray-300'} ${isEditing ? '' : 'pointer-events-none'}`}
                              >
                                ★
                              </button>
                            ))}
